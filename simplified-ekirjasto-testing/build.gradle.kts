...
android {
    ...
    defaultConfig {
        var circulationApiUrl = overrideProperty("ekirjasto.testLogin.circulationApiUrl")
        buildConfigField("String", "TEST_LOGIN_CIRCULATION_API_URL", "\"$circulationApiUrl\"")
        var libraryProviderId = overrideProperty("ekirjasto.testLogin.libraryProviderId")
        buildConfigField("String", "TEST_LOGIN_LIBRARY_PROVIDER_ID", "\"$libraryProviderId\"")
    }
}
