...
include(":simplified-ekirjasto-magazines")
include(":simplified-ekirjasto-testing")
include(":simplified-ekirjasto-testing-ui")
include(":simplified-ekirjasto-util")
...
include(":ekirjasto-theme")
project(":ekirjasto-theme").projectDir = file("./ekirjasto-theme")
include(":ekirjasto-theme:core")
